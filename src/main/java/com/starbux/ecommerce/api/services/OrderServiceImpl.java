...
import com.starbux.ecommerce.api.exception.ProductNotAllowedException;
    ...
    public Order createUpdateOrder(OrderRequestDto orderRequest) {
         ...
         */
            ...
            if (productList.contains(product)) {
                throw new ProductNotAllowedException(product.getProduct_Id());
            } else {
            ...
            throw new OrderNotFoundException("There has been some issue creating your order. We are working on to resolve it " + exc.getConstraintName() + exc.getMessage());
        }
    }
